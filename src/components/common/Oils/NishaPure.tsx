                                        ...
                                        <div className={`flex flex-wrap sm:flex-nowrap items-center gap-4 sm:gap-6 p-4 rounded-3xl border ${isDark ? 'bg-slate-900/50 border-white/5' : 'bg-slate-50 border-slate-200 shadow-inner'}`}>
                                            <div className="flex flex-col items-center flex-1 sm:flex-none">
                                                ...
                                                <div className={`flex items-center gap-1 mt-1 p-1 rounded-2xl border ${isDark ? 'bg-slate-950 border-white/10' : 'bg-white border-slate-200 shadow-sm'}`}>
                                                    ...
                                                    <input type="number" min="0" value={cart[product.id + '_box'] || ''} onChange={(e) => handleManualQuantity(product.id + '_box', parseInt(e.target.value) || 0)} placeholder="0" className={`w-10 text-center text-[16px] font-black bg-transparent outline-none ${isDark ? 'text-white' : 'text-slate-900'} [-moz-appearance:_textfield][&::-webkit-inner-spin-button]:m-0[&::-webkit-inner-spin-button]:appearance-none`} />
                                                    <button onClick={() => updateQuantity(product.id + '_box', 1)} className={`w-8 h-8 rounded-xl bg-${primaryColor}-500 text-white flex items-center justify-center transition-all hover:bg-${primaryColor}-600 shadow-md shadow-${primaryColor}-500/20`}>
                                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M12 4v16m8-8H4" /></svg>
                                                    </button>
                                                </div>
                                            ...
                                            <div className="flex flex-col items-center flex-1 sm:flex-none">
                                                ...
                                                <div className={`flex items-center gap-1 mt-1 p-1 rounded-2xl border ${isDark ? 'bg-slate-950 border-white/10' : 'bg-white border-slate-200 shadow-sm'}`}>
                                                    ...
                                                    <input type="number" min="0" step="0.5" value={cart[product.id + '_ltr'] || ''} onChange={(e) => handleManualQuantity(product.id + '_ltr', parseFloat(e.target.value) || 0, product)} placeholder="0" className={`w-10 text-center text-[16px] font-black bg-transparent outline-none ${isDark ? 'text-white' : 'text-slate-900'} [-moz-appearance:_textfield][&::-webkit-inner-spin-button]:m-0[&::-webkit-inner-spin-button]:appearance-none`} />
                                                    <button onClick={() => updateQuantity(product.id + '_ltr', 0.5)} className={`w-8 h-8 rounded-xl bg-${primaryColor}-500 text-white flex items-center justify-center transition-all hover:bg-${primaryColor}-600 shadow-md shadow-${primaryColor}-500/20`}>
                                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M12 4v16m8-8H4" /></svg>
                                                    </button>
                                                </div>
                                        ...
                                        <div className={`flex flex-wrap sm:flex-nowrap items-center gap-4 sm:gap-6 p-4 rounded-3xl border ${isDark ? 'bg-slate-900/50 border-white/5' : 'bg-slate-50 border-slate-200 shadow-inner'}`}>
                                            ...
                                            <div className="flex flex-col items-center flex-1 sm:flex-none">
                                                ...
                                                <div className={`flex items-center gap-1 mt-1 p-1 rounded-2xl border ${isDark ? 'bg-slate-950 border-white/10' : 'bg-white border-slate-200 shadow-sm'}`}>
                                                    ...
                                                    <input type="number" min="0" step="1" value={cart[product.id] || ''} onChange={(e) => handleManualQuantity(product.id, parseFloat(e.target.value) || 0, product)} placeholder="0" className={`w-10 text-center text-[16px] font-black bg-transparent outline-none ${isDark ? 'text-white' : 'text-slate-900'} [-moz-appearance:_textfield][&::-webkit-inner-spin-button]:m-0[&::-webkit-inner-spin-button]:appearance-none`} />
                                                    <button onClick={() => updateQuantity(product.id, 1)} className={`w-8 h-8 rounded-xl bg-${primaryColor}-500 text-white flex items-center justify-center transition-all hover:bg-${primaryColor}-600 shadow-md shadow-${primaryColor}-500/20`}>
                                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M12 4v16m8-8H4" /></svg>
                                                    </button>
                                                </div>
                                        ...
                                        <div className={`flex flex-wrap sm:flex-nowrap items-center gap-4 sm:gap-6 p-4 rounded-3xl border ${isDark ? 'bg-slate-900/50 border-white/5' : 'bg-slate-50 border-slate-200 shadow-inner'}`}>
                                            ...
                                            <div className="flex flex-col items-center flex-1 sm:flex-none">
                                                ...
                                                <div className={`flex items-center gap-1 mt-1 p-1 rounded-2xl border ${isDark ? 'bg-slate-950 border-white/10' : 'bg-white border-slate-200 shadow-sm'}`}>
                                                    ...
                                                    <input type="number" min="0" step="2" value={cart[product.id] || ''} onChange={(e) => handleManualQuantity(product.id, Math.round((parseFloat(e.target.value) || 0) / 2) * 2)} placeholder="0" className={`w-10 text-center text-[16px] font-black bg-transparent outline-none ${isDark ? 'text-white' : 'text-slate-900'} [-moz-appearance:_textfield][&::-webkit-inner-spin-button]:m-0[&::-webkit-inner-spin-button]:appearance-none`} />
                                                    <button onClick={() => updateQuantity(product.id, 2)} className={`w-8 h-8 rounded-xl bg-${primaryColor}-500 text-white flex items-center justify-center transition-all hover:bg-${primaryColor}-600 shadow-md shadow-${primaryColor}-500/20`}>
                                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M12 4v16m8-8H4" /></svg>
                                                    </button>
                                                </div>
