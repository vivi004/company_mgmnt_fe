            ...
            {cartItems.length > 0 && (
                <div className="flex justify-end gap-6 mt-10">
                    ...
                    <button
                        ...
                        disabled={placing}
                        className="px-10 py-5 bg-emerald-600 hover:bg-emerald-700 disabled:opacity-60 disabled:cursor-not-allowed text-white font-black rounded-2xl text-sm uppercase tracking-widest transition-all shadow-xl shadow-emerald-600/30 hover:-translate-y-0.5 active:scale-95 flex items-center gap-3"
                    >
                        {placing ? (
                            <>
