...
const BillPageStaff = ({ shopName, villageName, theme, cart, invoiceNo, onNewOrder, onEditOrder }: Props) => {
    ...
    const invNo = invoiceNo || Math.floor(5000 + Math.random() * 1000);
        ...
        <div className={`min-h-screen pb-10 animate-in fade-in slide-in-from-right-5 duration-500 ${isDark ? 'text-white' : 'text-slate-900'}`}>
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-6 md:mb-8">
                ...
                <div className="flex flex-wrap gap-3 md:gap-4 w-full md:w-auto">
                    <button onClick={handlePDF} className="flex-1 md:flex-none justify-center px-4 md:px-8 py-3 md:py-4 bg-emerald-600 hover:bg-emerald-700 text-white font-black rounded-xl md:rounded-2xl text-xs md:text-sm uppercase tracking-widest transition-all shadow-xl shadow-emerald-600/30 hover:-translate-y-0.5 active:scale-95 flex items-center gap-2">
