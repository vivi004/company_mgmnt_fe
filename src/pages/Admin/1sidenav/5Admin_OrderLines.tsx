                            ...
                            <div className="flex justify-end items-center mt-6 pt-6 border-t border-slate-100/5">
                                <div className="flex space-x-2">
                                    <button
                                        ...
                                        className={`p-2 rounded-xl transition-all border ${theme === 'dark' ? 'bg-white/5 border-white/10 text-slate-400 hover:text-blue-400' : 'bg-blue-50 border-blue-100 text-blue-500 hover:bg-blue-600 hover:text-white'}`}
                                        title="Edit Node"
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`p-2 rounded-xl transition-all border ${theme === 'dark' ? 'bg-white/5 border-white/10 text-slate-400 hover:text-red-500' : 'bg-red-50 border-red-100 text-red-500 hover:bg-red-600 hover:text-white'}`}
                                        title="Delete Node"
                                    >
                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
